...
export const MovieError = ({ message = 'Something went wrong' }: MovieErrorProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
      <div className="max-w-md text-center">
        ...
        >
          <span className="transform group-hover:-translate-x-1 transition-transform duration-300">←</span> Go Back
        </Button>
      </div>
    </div>
  )
